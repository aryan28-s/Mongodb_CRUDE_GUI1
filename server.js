...
// MongoDB connection local host
// mongoose.connect('mongodb://localhost:27017/mongdb_crud_gui', { useNewUrlParser: true, useUnifiedTopology: true })
//     .then(() => console.log('Connected to MongoDB'))
//     .catch(err => console.error('Error connecting to MongoDB', err));

// MongoDB connection
mongoose.connect('mongodb+srv://Test1234:Test1234@cluster0.tomuw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => console.log('Connected to MongoDB'))
    .catch(err => console.error('Error connecting to MongoDB', err));
